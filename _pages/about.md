...
* ***Ziyi Ye***, Xiaohui Xie, Qingyao Ai, Yiqun Liu, Zhihong Wang, Weihang Su, and Min Zhang. Relevance Feedback with Brain Signals. (***TOIS***, CCF A). [Code](https://github.com/THUIR/Brain-Relevance-Feedback).[Preprint Version](https://arxiv.org/abs/2312.05669). [Code](https://github.com/THUIR/Brain-Relevance-Feedback).
